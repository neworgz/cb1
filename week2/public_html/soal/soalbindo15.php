	...
	<div id="wrapper">
		<div id="header">
			...
			<nav id="navigasi"><ul>
				...
				<!-- HOME-->
				<li>
					<a href="home.html"><img id="lghome" src="gambar/homelg.png" title="Home"></a><a id="thome" href="home.php">HOME</a>
		...
		<div id="content"><br>
			...
			<h3 id="namapel">Bahasa Indonesia</h3><hr>
				...
				<?php
					include "koneksi.php";
					$sql = mysql_query("SELECT * FROM sbindo where tahun=2015 " );
					...
					while ($data=mysql_fetch_array($sql)) { 
						...
						if($data['bacaan'] == ""){
							...
							//echo "$data[bacaan]";
							?>
							<div id="button"><a href="#popup">Lampiran</a></div>
    							<div id="popup">
    							<div class="window">
