...
<body>
	<div id="wrapper">
		...
		<div id="content"><br>
			<div id="deskripsi">
				<h3 id="namapel" style="display:inline;">Ilmu Pengetahuan Alam</h3>
				<?php 
				$_SESSION['mapel'] = 'IPA';
				$_SESSION['jenis'] = 'ipa';
				?>
					  	...
					  	<tbody>
					  		<?php  
								...
								$start = $limit*($page-1);
						  		...
						  		$no=$start+1;
						  		$query = mysql_query("SELECT * from sipa limit $start, $limit");
						  		$tot   = mysql_query("SELECT * FROM sipa");
						...
						function pagination($page, $num_page){
							...
							for($i=1; $i<=$num_page; $i++){
								if ($i == $page) {
									...
									echo '<li style="float:left;padding:5px;text-decoration:none;"><a href="guru_mapelipa.php?p= '.$i.' ">'.$i.'</a></li>';
								}
							}
							echo "</ul>";
						}
