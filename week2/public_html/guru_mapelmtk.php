...
include("koneksi.php");
session_start();
	if(isset($_SESSION['id']) AND isset($_SESSION['guru'])){
		$id = $_SESSION['id'];
	}
	else{	
		if(isset($_POST['id']) AND isset($_POST['password']) AND isset($_SESSION['guru']) ){
	...
	<div id="wrapper">
		<div id="header">
			...
			<nav id="navigasi"><ul>
				...
				<!-- HOME-->
				<li>
					<a href="guru_home.php"><img id="lghome" src="gambar/homelg.png" title="Home"></a><a id="thome" href="guru_home.php">HOME</a>
				...
				<a id="tmapel" href="#">MAPEL</a><span class="lgcucuk"><img class="lgcucuk" src="gambar/cucuk.gif" title="Mapel"></span>
			 		<ul id="dropdown">
 						<li><a href="guru_mapelbindo.php">Bahasa Indonesia</a></li>
						<li><a href="guru_mapelmtk.php">Matematika</a></li>
						<li><a href="guru_mapelipa.php">Ilmu Pengetahuan Alam</a></li>
		    		</ul>
				</li><br class="enterlogo" />
		...
		<div id="content"><br>
			<div id="deskripsi">
				<h3 id="namapel" style="display:inline;">Matematika</h3>
				<?php 
				$_SESSION['mapel'] = 'Matematika';
				$_SESSION['jenis'] = 'mtk';
				?>

				<a href="tambahSoal.php"><button action="tambahSoal.php" name="tambahsoal" id="butambah" >Tambah Soal</button></a><hr>
					  	...
					  	<tbody>
					  		<?php  
								...
								$start = $limit*($page-1);
						  		...
						  		$no=$start+1;
						  		$query = mysql_query("SELECT * from smtk limit $start, $limit");
						  		$tot   = mysql_query("SELECT * FROM smtk");
						...
						function pagination($page, $num_page){
							...
							for($i=1; $i<=$num_page; $i++){
								if ($i == $page) {
									...
									echo '<li style="float:left;padding:5px;text-decoration:none;"><a href="guru_mapelmtk.php?p= '.$i.' ">'.$i.'</a></li>';
								}
							}
							echo "</ul>";
						}
